// courtesy of hero icons and feather icons
  ...
  return (
    <svg aria-hidden="true" focusable="false" className="hidden">
      <defs>
        ...
        <symbol id="linkedin">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-linkedin">

...
export const ThesisWriting = () => {
  ...
  useEffect(() => {
    fetchReviews(setReviews, [174])
    fetchPosts(setPosts, 174)
    fetchSamples(setSamples, 174)
  }, [])
    ...
    <>
      ...
      <section className="flex flex-col md:flex-row-reverse justify-around">
        ...
        <div className="flex flex-col justify-center w-1/3">
          <h1 className="text-5xl font-bold mb-5">Thesis Writing</h1>
          <p className="text-2xl font-bold text-gray-600">Top rated thesis writing help service. Amazing results, reasonable prices.</p>
        </div>
      </section>

      <section className="my-10">
        <h2 className="text-3xl font-bold text-center mb-5">Why Do People Need Online Thesis Writing Help?</h2>

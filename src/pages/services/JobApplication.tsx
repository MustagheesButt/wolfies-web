...
export const JobApplication = () => {
  ...
  return (
    <>
      <Head title="Job Application Help - CVs, Resumes & Cover Letters" />
      <section className="flex flex-col md:flex-row-reverse justify-around">
        ...
        <div className="flex flex-col justify-center w-1/3">
          <h1 className="text-5xl font-bold mb-5">Job Application Help</h1>
          <p className="text-2xl font-bold text-gray-600">
            Job seeking, and career development can be stressful and challenging. Let us help!
          </p>
        </div>
      </section>

      <section className="my-10">
        <h2 className="text-3xl font-bold text-center mb-5 mx-80">How Can a Professional Job Application Service Help You Get That Job Faster?</h2>
        <div className="text-center w-1/3 m-auto">
          <p className="mb-5">
            You've got your education done, and now it's time to land that dream job. Great! But wait... Nobody ever
            taught you how to write a professional resume and cover letter, or how to design a highly converting Linkedin
            profile. Save yourself some time, and let us help you get your dream job faster.
          </p>
          <Link to='/blog/how-can-a-professional-job-application-service-help' className="font-bold">Read More</Link>
        </div>
      </section>

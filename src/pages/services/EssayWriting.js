...
export const EssayWriting = () => {
  ...
  useEffect(() => {
    fetchReviews(setReviews, [172])
    fetchPosts(setPosts, 172)
    fetchSamples(setSamples, 172)
  }, [])
  ...
  return (
    <>
      <Head title="Essay Writing" />
      <section className="flex flex-col md:flex-row-reverse justify-around">
        <Player src={R.anim.essays} style={{ width: "400px", height: "400px" }} autoplay loop />
        <div className="flex flex-col justify-center w-1/3">
          <h1 className="text-5xl font-bold mb-5">Essay Writing</h1>

...
export const Dissertations = () => {
  ...
  useEffect(() => {
    fetchReviews(setReviews, [171])
    fetchPosts(setPosts, 171)
    fetchSamples(setSamples, 171)
  }, [])
  ...
  return (
    <>
      <Head title="Dissertations" />
      <section className="flex flex-col md:flex-row-reverse justify-around">
        <Player src={R.anim.dissertations} style={{ width: "400px", height: "400px" }} autoplay loop />
        <div className="flex flex-col justify-center w-1/3">
          <h1 className="text-5xl font-bold mb-5">Dissertations</h1>
          <p className="text-2xl font-bold text-gray-600">Top rated dissertation help service. Amazing results, reasonable prices.</p>
        </div>
      </section>

      <section className="my-10">
        <h2 className="text-3xl font-bold text-center mb-5">Why Do People Need Online Dissertation Help?</h2>
        <div className="text-center w-1/3 m-auto">
          <p className="mb-5">A lot of people go to other countries to get jobs in order to support their families,
            ...
            don't have the time to work on bullshit assignments, projects and presentations. That's when dissertation help services come in play</p>
